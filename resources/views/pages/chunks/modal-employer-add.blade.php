<form method="post" name="formAdd" v-on:submit.prevent="storeEmployer">
<div class="modal fade" id="addEmployerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
              ...
              <input type="text" v-model="form.nationality" placeholder="nationality" class="form-control" >
          </div>
          <div class="form-group">
              <label >Genero</label>
