<form method="post" name="formEdit" v-on:submit.prevent="updateEdition">
<div class="modal fade" id="editEditionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Actualizar Edicion</h5>
