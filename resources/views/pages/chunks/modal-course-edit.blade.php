<form method="post" name="formEdit" v-on:submit.prevent="updateCourse">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" v-model="form.descripcion">@{{form.descripcion}}</textarea>
            </div>
            <div class="form-group">
                <label class="col-form-label">Duración:</label>
                <input type="text" v-model="form.duracion" class="form-control" >
            </div>
            <div class="form-group">
                <label class="col-form-label">Costo:</label>
                <input type="text" v-model="form.costo" class="form-control" >
            </div>
            <div class="form-group">
